...
export const createProject = async (req: Request, res: Response) => {
  try {
    ...
    const linksResult = await createLinks(connections, project_id);
  ...
  async function createLinks(links: Link[], projectId: string) {
  ...
  async function createNode(canvasComponents: Device[], project_id: string) {
    try {
      ...
      for (const component of canvasComponents) {
        let payload: any;
        //console.log(component.deviceType + " " + component.modelType);
